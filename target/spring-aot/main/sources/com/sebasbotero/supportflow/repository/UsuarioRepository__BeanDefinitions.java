...
public class UsuarioRepository__BeanDefinitions {
  ...
  public static BeanDefinition getUsuarioRepositoryBeanDefinition() {
    ...
    beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, "com.sebasbotero.supportflow.repository.UsuarioRepository");
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragmentsFunction", new RepositoryFactoryBeanSupport.RepositoryFragmentsFunction() {
      public RepositoryComposition.RepositoryFragments getRepositoryFragments(
        ...
        return RepositoryComposition.RepositoryFragments.just(new com.sebasbotero.supportflow.repository.UsuarioRepositoryImpl__AotRepository(entityManager, context));
      }
    });
